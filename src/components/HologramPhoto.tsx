...
import monikaPhoto from "@/assets/monika-nobg.png";
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: "0 0 60px hsl(265, 85%, 65%, 0.15), 0 0 120px hsl(265, 85%, 65%, 0.05), inset 0 0 60px hsl(265, 85%, 65%, 0.05)",
          }}
        >
          ...
          <motion.div
            ...
            style={{ boxShadow: "0 0 20px hsl(265, 85%, 65%, 0.4), 0 0 60px hsl(265, 85%, 65%, 0.2)" }}
          />
          ...
          <div
            ...
            style={{
              backgroundImage: `
                linear-gradient(0deg, hsl(265, 85%, 65%) 1px, transparent 1px),
                linear-gradient(90deg, hsl(265, 85%, 65%) 1px, transparent 1px)
              `,
          ...
          <motion.div
            ...
            style={{
              background: `linear-gradient(135deg, 
                hsl(265, 85%, 65%, 0.3) 0%, 
                hsl(320, 85%, 65%, 0.2) 30%, 
                transparent 50%, 
                hsl(45, 90%, 60%, 0.15) 70%, 
                hsl(265, 85%, 65%, 0.2) 100%)`,
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "inset 0 0 30px hsl(265, 85%, 65%, 0.05)",
            }}
          />
        </motion.div>
        ...
        {[
          ...
          return (
            <motion.div
              ...
              whileHover={{ scale: 1.3, boxShadow: `0 0 20px hsl(${node.color === "primary" ? "265, 85%, 65%" : "320, 85%, 65%"}, 0.5)` }}
            ...
            >
              ...
              >
                <line
                  ...
                  stroke={node.color === "primary" ? "hsl(265, 85%, 65%)" : "hsl(320, 85%, 65%)"}
                  strokeWidth="1"
                  strokeDasharray="3 3"
                />
              </svg>
